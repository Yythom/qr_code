...
function O_list(props) {
    ...
    return (
        ...
        <div className='product_list'>
            <div className='shop_wrap' onClick={() => {

                history.push(`/integral/home?s=${order_detail.shop.short}&isOrderDetail=1`);
            }}>
                {order_detail.shop.logo
                    ? <img className='img' src={order_detail.shop.logo} alt="a" />
                ...
                <div className='text'>
                    <span>{order_detail.shop.shop_name}</span>
                    <aside style={!order_detail.shop.is_business ? { backgroundColor: '#999' } : null}>
                        ...
                        {!order_detail.shop.is_business ? <span>已打烊</span> : <span>营业中</span>}
                    </aside>
                </div>
            </div>
                        ...
                        return (
                            (!more && i < 2) ? <li key={e.product_id} className='cashier_foot_item'>
                                <div className='desc_wrap'>
                                    <div className='e_img'>
                                        <img src={e.product_picture} alt="加载失败" />
                                    </div>
            ...
            <div className="call_footer">
                <a href={`tel:${order_detail.shop.contact}`} className='call' style={{ color: ' color: rgba(9, 44, 76, 1)' }}>
                    <img src={phone} alt="" />
                    <span >联系商家</span>
                </a>
                <div className='price_box'>
                    <div className='money'>
                        <p>
                            合计：
                            {
                                order_detail.order.type_message === '代币' ? <span>{order_detail.price} 币</span> : <span>¥{order_detail.price}</span>
                            }
                        </p>
                    </div>
                </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(O_list)
