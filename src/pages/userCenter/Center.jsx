...
function User_center(props) {
    ...
    useEffect(() => {
        init();
        console.log(props.userStore, '1231');
        if (!props.userStore) {
        ...
        <>
            {
                <div className="center_wrap animate__fadeIn animate__animated">
                    ...
                    <div className="handle_wrap">
                        <div className="item_box" onClick={() => history.push('/integral/center/phone')}>
                            <li>
                                <span>我的手机号</span>
                                <div>
                        ...
                        <div className="item_box" onClick={() => history.push('/integral/center/change-password')}>
                            <li>
                                <span>修改密码</span>
                                <div>
                                    <span style={{ verticalAlign: 'middle' }}>修改</span>
                        ...
                        <div className="item_box" onClick={() => history.push('/integral/center/address')}>
                            <li>
                                <span>收货地址</span>
                                <div>
                                    <span style={{ verticalAlign: 'middle' }}>修改</span>
                        ...
                        <div className="item_box" onClick={() => history.push('/integral/center/booked')}>
                            <li>
                                <span>入账订单</span>
                                <div>
